            ...
            <div class="row">
                ...
                <div class="col-md-7 mt-3">
                    <div class="product-view">
                        ...
                        <div class="mt-2">
                            <button type="buttton" wire:click="addToCart({{ $product->id }})" class="btn btn1">
                            ...
                            <div class="item mb-3">
                                <div class="product-card">
                                    ...
                                    <div class="product-card-body">
                                        ...
                                        <div>
                                            <span class="selling-price">₱{{ number_format($relatedProductItem->selling_price), 2 }}</span>
                                            <span class="original-price">₱{{ number_format($relatedProductItem->original_price), 2 }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
