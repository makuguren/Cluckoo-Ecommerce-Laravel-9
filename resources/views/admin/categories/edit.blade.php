...
@section('title', 'Edit Category - Cluckoo')
@section('content')
                ...
                @method('PUT')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="slug" value="{{ $category->slug }}" class="form-control ih-medium ip-light radius-xs b-light px-15" id="a10">
                            ...
                            <div class="form-group form-element-textarea mb-20">
                                ...
                                <div class="checkbox-theme-default custom-checkbox ">
                                    <input class="checkbox" type="checkbox" name="status" id="check-un1" {{ $category->status == '1' ? 'checked':'' }} />
                                    <label for="check-un1">
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="a10" class="il-gray fs-14 fw-500 align-center">Name</label>
                                <input type="text" name="meta_title" value="{{ $category->meta_title }}" class="form-control ih-medium ip-light radius-xs b-light px-15" id="a10">
                                @error('meta_title')<small class="text-danger">{{$message}}</small> @enderror
                            </div>

                            <div class="form-group form-element-textarea mb-20">
                                <label for="exampleFormControlTextarea1" class="il-gray fs-14 fw-500 align-center">Meta Keyword</label>
                                <textarea name="meta_keyword" class="form-control" id="exampleFormControlTextarea1" rows="3">{{ $category->meta_keyword }}</textarea>
                                @error('meta_keyword')<small class="text-danger">{{$message}}</small> @enderror
                            </div>

                            <div class="form-group form-element-textarea mb-20">
                                <label for="exampleFormControlTextarea1" class="il-gray fs-14 fw-500 align-center">Meta Description</label>
                                <textarea name="meta_description" class="form-control" id="exampleFormControlTextarea1" rows="3">{{ $category->meta_description }}</textarea>
