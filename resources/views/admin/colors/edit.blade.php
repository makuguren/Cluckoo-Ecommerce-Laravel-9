...
@section('title', 'Edit Color - Cluckoo')
@section('content')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ $color->name }}" class="form-control ih-medium ip-light radius-xs b-light px-15" id="a10">
                                @error('name')<small class="text-danger">{{$message}}</small> @enderror
                            </div>

                            <div class="form-group">
                                <label for="a10" class="il-gray fs-14 fw-500 align-center">Code</label>
                                <input type="text" name="code" value="{{ $color->code }}" class="form-control ih-medium ip-light radius-xs b-light px-15" id="a10">
                            ...
                            <div class="form-group form-element-textarea mb-20">
                                ...
                                <div class="checkbox-theme-default custom-checkbox ">
                                    <input class="checkbox" type="checkbox" name="status" id="check-un1" {{ $color->status ? 'checked':'' }}>
                                    <label for="check-un1">
